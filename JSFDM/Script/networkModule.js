...
function obj_DisplayForm() {
  ...
  try {
    ...
    var controls =  SMToolControlInfo.ControlRepository.obj_DisplayForm
...
function obj_btnView() {
  ...
  try {
    ...
    controls = SMToolControlInfo.ControlRepository.obj_btnView
...
function obj_btnAddNew() {
  ...
  try {
    ...
    controls = SMToolControlInfo.ControlRepository.obj_btnAddNew
...
function obj_btnEdit() {
  ...
  try {
    ...
    if (!displayForm || !displayForm.Exists) {
     ...
     controls = SMToolControlInfo.ControlRepository.obj_btnEdit
...
function obj_btnDelete() {
  ...
  try {
    ...
    controls = SMToolControlInfo.ControlRepository.obj_btnDelete
...
function obj_btnExitDisp() {
  ...
  try {
    ...
    controls = SMToolControlInfo.ControlRepository.obj_btnExitDisp
...
function obj_LicenseForm() {
  ...
  try {
    let mainForm = serverKeywords.obj_ServerManagerMainForm();
    controls = SMToolControlInfo.ControlRepository.obj_LicenseForm
...
function obj_SelectResource() {
  ...
  try {
    let mainForm = serverKeywords.obj_ServerManagerMainForm();
    controls = SMToolControlInfo.ControlRepository.obj_SelectResource
...
function obj_ComPortComboBox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    controls = SMToolControlInfo.ControlRepository.obj_ComPortComboBox
...
function obj_BaudRateComboBox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
     controls = SMToolControlInfo.ControlRepository.obj_BaudRateComboBox
...
function obj_RetryCountTextBox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_RetryCountTextBox;
...
function obj_StartAddrTextBox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_StartAddrTextBox;
...
function obj_MuxEndAddrTextBox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_MuxEndAddrTextBox;
...
function obj_OKButton() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_OKButton
...
function obj_CancelButton() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_CancelButton
...
function obj_EnableMuxMonitorCheckbox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_EnableMuxMonitorCheckbox
...
function obj_ExperionServerTextBox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_ExperionServerTextBox
...
function obj_NonRedundantRadioButton() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_NonRedundantRadioButton
...
function obj_RedundantRadioButton() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_RedundantRadioButton
...
function obj_EnableSafetyManagerCheckbox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_EnableSafetyManagerCheckbox
...
function obj_OneWirelessManagerCheckbox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_OneWirelessManagerCheckbox
...
function obj_SecondaryServerTextBox() {
  ...
  try {
    let addEditForm = obj_addEditFrom();
    var controls = SMToolControlInfo.ControlRepository.obj_SecondaryServerTextBox
...
function obj_ViewDetailsForm() {
  ...
  try {
    let mainForm = serverKeywords.obj_ServerManagerMainForm(); 
    var controls = SMToolControlInfo.ControlRepository.obj_ViewDetailsForm
