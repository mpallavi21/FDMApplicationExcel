...
function OfflineConfig_HARTDDdevice_EPKSNW15785() {
  ...
  try {
      ...
      treeView.ClickItemR("|FDM Server ( DESKTOP-AJ7O5O5 )|ESHART|ESHART|C300_69|AI-HART_39|AICHANNEL_01_1");
      treeView.StripPopupMenu.Click();
...
function OnlineMuxdevices15797() {
  ...
  try {
    ...
    let HCMClient = Aliases.HCMClient;
    let treeView = HCMClient.ClientMainWindow.panelLeftPanMain.tabControlLeftPanMain.tabPageOnlineView.panelOnlineView.panelTabControlOnlineView.tabControlOnlineView.tabConnected.treeView;
...
function OptionsFunction() {
  Log.AppendFolder("OptionsFunction");
  ...
  try {
    ...
    Log.Error("Error in OptionsFunction: " + error.message);
